...
const HowItWorks = () => {
  ...
  return (
    <>
      <>
        <Helmet>
          <title>How it Works - BooksArc Kisumu</title>
          <meta name="description" content="Get help on how to use BooksArc" />
      ...
      <>
        <section className="px-6 py-20 bg-white/70 backdrop-blur-sm mt-14">
          ...
          <p className="text-center text-gray-600 max-w-2xl mx-auto text-lg mb-16">
            Discover how our peer-to-peer book sharing system empowers readers
            and connects communities through trust, transparency, and knowledge.
          </p>
