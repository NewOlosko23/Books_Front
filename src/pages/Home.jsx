...
const Home = () => {
  return (
    <>
      <>
        <Helmet>
          <title>BooksArc - Find and Hire Books in Kisumu</title>
          <meta
            name="description"
            content="Discover, hire, or recommend books in Kisumu with BooksArc. Browse a wide selection and get the books you want."
          />
          <meta name="robots" content="index, follow" />
          <meta
            name="keywords"
            content="books, Booksarc,  Kisumu, hire books, recommend books"
          />
        </Helmet>
      </>
      <>
            ...
            >
              ...
              <div className="backdrop-blur-sm shadow-sm rounded-2xl px-6 md:px-12 py-10">
                <p className="text-lg text-gray-700 leading-relaxed">
                  <span className="font-semibold text-gray-900">BooksArc</span>{" "}
                  is a peer-to-peer book lending platform that redefines how
                  people access books. Whether you're looking to borrow a
                  bestseller or rent out your personal collection, our
                  community-driven system connects readers across Kenya.
                </p>

                <p className="mt-6 text-lg text-gray-700 leading-relaxed">
                  We believe in the power of stories to connect people — and
                  now, you can lease or lend books without the traditional
                  hassle. With easy subscriptions, location-based exchanges, and
                  a growing library, reading has never been this flexible or
                  affordable.
                </p>
              </div>
            </motion.div>
            ...
            <section className="py-20 bg-white/70 backdrop-blur-sm px-4 md:px-16">
              ...
              >
                ...
                <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12 text-lg">
                  Whether you're a casual reader or a bookworm, choose a plan
            ...
            <section className="py-20 bg-white/100 backdrop-blur-sm px-4 md:px-16">
              ...
              >
                ...
                <p className="text-center max-w-3xl mx-auto text-gray-600 text-lg mb-12">
                  We're more than just a platform. We’re a community of readers
                  who believe that books should be within reach — always. Here's
